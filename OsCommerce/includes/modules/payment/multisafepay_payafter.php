...
class multisafepay_payafter {
    ...
    function get_shipping_methods($weight) {
        ...
        if (!empty($GLOBALS['_SESSION']['language'])) {
            require_once('includes/languages/' . $GLOBALS['_SESSION']['language'] . '/modules/payment/multisafepay_payafter.php');
        }
    ...
    function before_process() {
        ...
        tep_redirect($this->_start_payafter());
    }
    ...
    function _start_payafter() {
        ...
        $msp->customer['locale'] = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_LOCALE;
    ...
    function checkout_notify() {
        ...
        switch ($status) {
            case "initialized":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_INITIALIZED;
                $reset_cart = true;
                break;
            case "completed":
                if ($old_order_status == MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_INITIALIZED || $old_order_status == DEFAULT_ORDERS_STATUS_ID || !$old_order_status) {
                    $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_COMPLETED;
                    $reset_cart = true;
                ...
                break;
            case "uncleared":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_UNCLEARED;
                break;
            case "reserved":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_RESERVED;
                break;
            case "void":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_VOID;
                break;
            case "declined":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_DECLINED;
                break;
            case "reversed":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_REVERSED;
                break;
            case "refunded":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_REFUNDED;
                break;
            case "refunded":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_PARTIAL_REFUNDED;
                break;
            case "expired":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_EXPIRED;
                break;
            case "cancelled":
                $new_order_status = MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_VOID;
                break;
    ...
    function _save_order() {
        ...
        if (MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_DISPLAY_CHECKOUT_ORDERS == 'False') {
        ...
        $sql_data_array = array('customers_id' => $customer_id,
            ...
            'date_purchased' => 'now()',
            //'orders_status' 				=> 	$order->info['order_status'],
            'orders_status' => MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_INITIALIZED,
    ...
    function _notify_customer($new_order_status = null) {
        ...
        $email_order = STORE_NAME . "\n" .
                EMAIL_SEPARATOR . "\n" .
                MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_EMAIL_TEXT_ORDER_STATUS . ' ' . $order->info['orders_status'] . "\n" .
    ...
    function check() {
        if (!isset($this->_check)) {
            $check_query = tep_db_query("SELECT configuration_value FROM " . TABLE_CONFIGURATION . " WHERE configuration_key = 'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_STATUS'");
    ...
    function install() {
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Account ID', 'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ACCOUNT_ID', '', 'Your merchant account ID', '6', '22', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Site ID', 'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_SITE_ID', '', 'ID of this site', '6', '23', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Site Code', 'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_SITE_SECURE_CODE', '', 'Site code for this site', '6', '24', now())");
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('Display checkout orders', 'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_DISPLAY_CHECKOUT_ORDERS', 'True', 'Displays new fast checkout orders before the transaction is completed', '6', '20', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Reserved Order Status',    'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_RESERVED',    0, 'Reserved', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Voided Order Status',      'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_VOID',        0, 'Cancelled', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
        ...
        tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) VALUES ('Set Reversed Order Status',    'MODULE_PAYMENT_MULTISAFEPAY_PAYAFTER_ORDER_STATUS_ID_REVERSED',    0, 'Undone', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
